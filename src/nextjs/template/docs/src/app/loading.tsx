    ...
    <div className="border-b border-[var(--border)] bg-[var(--surface)] text-[var(--text)]">
      <div className="mx-auto flex min-h-14 w-full max-w-[1600px] items-center gap-3 px-4 py-3 sm:px-6">
        ...
        <div className="ml-auto flex shrink-0 items-center gap-3">
          <div className="hidden h-9 w-28 rounded-full border border-[var(--border)] bg-[var(--surface-muted)] sm:block" />
      ...
      <div className="px-4 py-4 lg:px-4 lg:py-6">
        <div className="space-y-6">
          <div className="space-y-3">
            <div className="h-3 w-24 rounded-full bg-[var(--surface-strong)]" />
            <div className="space-y-2">
              {sidebarItems.slice(0, 3).map((item) => (
                <div key={item} className="h-4 w-full rounded-md bg-[var(--surface-muted)]" />
              ))}
            </div>
          </div>

          <div className="space-y-3">
            <div className="h-3 w-20 rounded-full bg-[var(--surface-strong)]" />
            <div className="space-y-2">
...
function FooterSkeleton() {
  return (
    <footer className="border-t border-[var(--border)] bg-[var(--surface)] px-4 pt-6 pb-16 sm:px-6 lg:px-12">
      <div className="mx-auto flex w-full max-w-[48rem] flex-col gap-6 sm:flex-row sm:items-center sm:justify-between lg:mx-0 lg:pl-4">
        <div className="flex items-center gap-5">
          <div className="h-4 w-4 rounded-full bg-[var(--surface-strong)]" />
          <div className="h-4 w-4 rounded-full bg-[var(--surface-strong)]" />
          <div className="h-4 w-4 rounded-full bg-[var(--surface-strong)]" />
        </div>
